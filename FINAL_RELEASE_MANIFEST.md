...
*   **SSO Ready:** OIDC scaffold and JIT provisioning logic written (Signature verification fully implemented and verified).
*   **Billing/Stripe:** Subscription webhook endpoint added (Signature verification fully implemented and verified).
