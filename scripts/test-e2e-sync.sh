...
# 4. Have sulcus download, decrypt, verify, and load it
#
...
# Step 5: Try loading the plugin via sulcus (if built)
echo ""
...
if cargo test -p sulcus plugin_load --release 2>&1 | tail -5; then
