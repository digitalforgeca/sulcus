# Homebrew formula for sulcus
# This is the source copy — the canonical formula lives at:
# https://github.com/digitalforgeca/homebrew-sulcus/blob/main/Formula/sulcus.rb
#
...
class SulcusLocal < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      url "https://github.com/digitalforgeca/sulcus/releases/download/v#{version}/sulcus-darwin-x86_64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/digitalforgeca/sulcus/releases/download/v#{version}/sulcus-linux-aarch64.tar.gz"
      # sha256 pending — aarch64-linux cross-compile in progress
    else
      url "https://github.com/digitalforgeca/sulcus/releases/download/v#{version}/sulcus-linux-x86_64.tar.gz"
  ...
  test do
    assert_match version.to_s, shell_output("#{bin}/sulcus --version 2>&1", 0).strip
  end
end
