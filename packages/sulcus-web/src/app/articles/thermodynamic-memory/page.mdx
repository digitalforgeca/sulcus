export const metadata = {
  ...
  description: 'Most AI memory systems are glorified databases. SULCUS treats memories as thermodynamic objects with heat, decay, resonance, and consolidation.',
};
