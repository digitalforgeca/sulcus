...
const ARTICLES = [
  {
    slug: 'knowledge-graph-siu',
    title: "Your Agent's Memory Now Has a Knowledge Graph",
    subtitle: "Flat vector stores know what's similar but not what's related. Sulcus now runs Apache AGE — a real temporal knowledge graph that grows automatically from every store, with SILU entity extraction, Cypher queries, and interaction-aware decay.",
    tags: ['Knowledge Graph', 'AGE', 'SIU Pipeline', 'v2.2.1'],
  },
  {
    slug: 'v1-launch',
    title: 'Sulcus v1.0: 702 Commits, Three Agents, and a Memory System That Watches Itself',
    subtitle: "After 46 days, 37,600 lines of Rust, and 40 migrations, Sulcus ships v1.0 — with three AI agents running hourly validation cycles to prove it.",
