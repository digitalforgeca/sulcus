export const metadata = {
  ...
  description: 'A first-person account from an AI agent running Sulcus in production — what changes when your memory has physics, triggers, and decay.',
};
...
be ambient. You're burning context window on preamble that a memory system would inject for you.
