            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <div className="bg-black/30 border border-[#D4AF37]/20 p-4 rounded">
                  ...
                  <p className="text-[10px] text-[#666] mb-3">SDK for any Python agent framework.</p>
                  <button
                ...
                <div className="bg-black/30 border border-[#D4AF37]/20 p-4 rounded">
                  ...
                  <p className="text-[10px] text-[#666] mb-3">SDK for any TypeScript project.</p>
                  <button
                    onClick={() => copy('npm install @digitalforgestudios/sulcus', 'node')}
                    className="w-full text-left bg-[#0a0a0a] px-3 py-2 rounded text-xs font-mono text-[#00F0FF] hover:bg-[#111] transition-colors cursor-pointer"
                  >
                    {copied === 'node' ? '✓ Copied' : '$ npm install @digitalforgestudios/sulcus'}
                  </button>
                </div>
              </div>
            </div>
