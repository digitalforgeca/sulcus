...
> **Note:** The Sulcus Local binary is distributed to licensed users. [Contact us](mailto:contact@sulcus.ca) for access or sign up for [Cortex tier](/dashboard/billing) which includes local sidecar access.
