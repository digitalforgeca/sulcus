...
export default function LocalPanelClient() {
  return (
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 font-sans">
        ...
        <div className="mb-10">
          ...
          <p className="text-[#888] text-base leading-relaxed">
            When <code className="text-[#00F0FF]">sulcus</code> runs in server mode it starts
        ...
        <section className="mb-14">
          ...
          <p className="text-sm text-[#ccc] leading-relaxed mb-6">
            <code className="text-[#00F0FF]">sulcus</code> has two run modes. In{' '}
            <strong className="text-white">server mode</strong> (
            <code className="text-[#00F0FF]">sulcus serve</code>), it starts the MCP
        ...
        <section className="mb-14">
          <SectionAnchor
            ...
            sub="Integral PostgreSQL — no external database required"
          />
          <p className="text-sm text-[#ccc] leading-relaxed mb-4">
            Sulcus Local uses <strong className="text-white">pg-embed</strong> — an embedded
            PostgreSQL 17 instance compiled into the binary. When you run{' '}
            <code className="text-[#00F0FF]">sulcus serve</code>, it automatically downloads
            (first run only) and starts a local Postgres process. Your data is stored in{' '}
            <code className="text-[#00F0FF]">~/.sulcus/data/</code> and persists across restarts.
          </p>
          <p className="text-sm text-[#ccc] leading-relaxed mb-4">
            <strong className="text-white">Why Postgres (not SQLite)?</strong> Sulcus Local uses
            the <em>exact same schema</em> as the cloud server. Every query, every migration, every
            column type is identical. This gives you:
          </p>
            ...
            {[
              ...
              <li key={title} className="flex items-start gap-2">
                ...
                <span className="text-xs text-[#888]">
                  <strong className="text-[#ededed]">{title}</strong> — {desc}
                </span>
              </li>
            ))}
          </ul>
          <div className="border border-[#00F0FF]/10 bg-[#00F0FF]/3 p-4 rounded">
            <p className="text-xs text-[#00F0FF]/80 leading-relaxed">
              <strong className="text-[#00F0FF]">Bring your own Postgres:</strong> Set{' '}
              <code className="text-[#00F0FF]">SULCUS_DATABASE_URL</code> to connect to an external
              Postgres instance instead. Sulcus Local will skip the embedded instance entirely.
            ...
            <table className="w-full text-xs border-collapse">
              ...
              <tbody className="text-[#aaa]">
                {([
                  ...
                  ['Availability', 'Only while sulcus is running', 'Always on'],
                  ['Mode required', 'sulcus serve', 'Any mode (cloud account)'],
