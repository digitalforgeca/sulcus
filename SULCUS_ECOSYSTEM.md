...
**Artifacts:** `crates/sulcus-core`, `crates/sulcus`, `packages/openclaw-sulcus`, `crates/sulcus-wasm`
...
**Purpose:** The "Trojan Horse" for developer adoption. Developers embed `sulcus` (via MCP or OpenClaw plugin) into their custom apps. It runs an embedded PGlite instance and provides the raw thermodynamic graph algorithms.
