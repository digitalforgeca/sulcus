...
# crates/sulcus-core and crates/sulcus into a clean workspace,
...
rsync -a --exclude='.fastembed_cache' "$SRC_ROOT/crates/sulcus/" "$PUBLIC_ROOT/crates/sulcus/"
...
[workspace]
resolver = "2"
members = ["crates/sulcus-core", "crates/sulcus"]
default-members = ["crates/sulcus-core", "crates/sulcus"]
...
git add -A
git commit -m "chore(release): initial public release of sulcus-core and sulcus"
