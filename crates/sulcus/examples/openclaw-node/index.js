...
// Usage: node index.js <path-to-sulcus-binary>
// This script spawns `sulcus serve` as a sidecar and exercises the full MCP surface.
...
if (require.main === module) {
  ...
  if (!bin) {
    console.error('Usage: node index.js <path-to-sulcus-binary>');
    process.exit(2);
  }
