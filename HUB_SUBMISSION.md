...
| Artifact | Type | URL |
|---|---|---|
| **Skill** | ClawHub Skill | [clawhub.ai/mcdoolz/openclaw-sulcus-skill](https://clawhub.ai/mcdoolz/openclaw-sulcus-skill) |
| **Plugin** | ClawHub Code Plugin | [clawhub.ai/packages/mcdoolz/@digitalforgestudios/openclaw-sulcus](https://clawhub.ai/packages/mcdoolz/@digitalforgestudios/openclaw-sulcus) |
